 ...
 */
public class CombiningLines {     // Save as "ArithmeticTest.java"
   public static void main(String[] args) {
      ...
      System.out.println(number1 + "and" + number2 + "are" + sum + ", " + difference + ", " + product + ", " + quotient + ", and " + remainder);      // Print the value of the variable
